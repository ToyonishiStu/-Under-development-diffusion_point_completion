...
- Whether replacing zero-filled missing regions with random noise improves Conv baselines.
...
Diffusion v1 underperforms Conv baselines, indicating that naïve application of diffusion is insufficient.

Diffusion v2 improves stability and conditioning but still struggles on sharp geometric transitions.
...
Faster sampling (e.g., DDIM)

Hybrid Conv + Diffusion architectures

Incorporation of geometric priors (e.g., ray continuity constraints)
