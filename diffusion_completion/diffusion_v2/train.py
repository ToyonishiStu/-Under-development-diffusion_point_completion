...
# -*- coding: utf-8 -*-
"""
Training Script for Diffusion v2 (Dual Encoder + FiLM) on 2D LiDAR Completion

Identical to diffusion/train.py except:
...
def main():
    parser = argparse.ArgumentParser(
        description="Train Diffusion v2 (Dual Encoder + FiLM) for 2D LiDAR Completion"
    )
    ...
    parser.add_argument("--num_res_blocks", type=int, default=2,
                        help="Number of FiLMResBlocks per encoder level")
